...
import TransCD.networks.configs as cfg
...
#             grid_size, patch_size, patch_size_on_image, n_patches))
        ...
        if self.hybrid:
            if config.backbone == 'ResNet18':
                from TransCD.networks.backbone import ResNet18 as ResNet
            elif config.backbone == 'ResNet34':
                from TransCD.networks.backbone import ResNet34 as ResNet     
            elif config.backbone == 'ResNet50':
                from TransCD.networks.backbone import ResNet50 as ResNet 
            elif config.backbone == 'ResNet101':
                from TransCD.networks.backbone import ResNet101 as ResNet
            else:
                from TransCD.networks.backbone import ResNet152 as ResNet
